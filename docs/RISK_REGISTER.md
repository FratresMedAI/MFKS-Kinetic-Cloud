...
| R-004 | Friendly fire / fratricide from flechette cloud | Low | Critical | Arming interlocks; elevation limits; training | Safety |
...
| R-010 | Regulatory / classification of kinetic counter-UAS | Low | High | Early legal review; kinetic-only advantage documented | Program |
